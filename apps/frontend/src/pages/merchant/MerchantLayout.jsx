...
import { LayoutDashboard, Brain, Package, BarChart2, Warehouse, Users, Tag, MessageSquare, Settings, Smartphone, ChevronRight, Zap } from 'lucide-react'
import './Merchant.css'
    ...
    <div className="merchant-root">
      ...
      <aside className="merchant-sidebar">
        <div className="merchant-sidebar-logo">
          <div className="merchant-logo-icon"><Zap size={20} /></div>
          <div>
            <div className="merchant-logo-name">Vyapar AI</div>
            <div className="merchant-logo-sub">Commerce Intelligence</div>
          </div>
        </div>
